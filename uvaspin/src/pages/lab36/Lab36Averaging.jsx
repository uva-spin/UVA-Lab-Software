...
function Lab36Averaging() {
    ...
    const { 
        ...
        fetchData, 
        clearCache 
    } = usePageDataCache('lab36-averaging');
    ...
    const plotConfig = {
        data: averagedData || [],
        layout: {
            title: `Lab 036 Averaged Data (N=${nPoints}, Sampling=${samplingFactor}x)`,
            xaxis: { 
                title: 'Time (EST)',
                type: 'date',
                showgrid: true,
        ...
        config: {
            ...
            toImageButtonOptions: {
                format: 'png',
                filename: `lab36_averaging_${new Date().toLocaleString()}`,
                height: 600,
                width: 1000,
                scale: 2
            }
